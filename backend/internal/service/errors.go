...
var (
	...
	ErrReviewOpen         = errors.New("an in-progress correction review already exists")
	ErrReviewNotOpen      = errors.New("correction review is not open or does not belong to this record")
	ErrReviewerSeparation = errors.New("correction reviewer must differ from the original signer")
)
