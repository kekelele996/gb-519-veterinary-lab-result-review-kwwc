...
var (
	...
	ErrCorrectionConflict = errors.New("a correction review is already in progress for this signed result")
	ErrCorrectionNotOpen  = errors.New("the correction review is not open for a decision")
	ErrSuperseded         = errors.New("the signed result has already been superseded by a correction")
)
